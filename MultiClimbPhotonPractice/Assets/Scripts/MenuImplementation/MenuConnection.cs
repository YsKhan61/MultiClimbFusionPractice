...
namespace MultiClimb.Menu
{
    ...
    {
        public MenuConnection(FusionMenuConfig config, NetworkRunner runnerPrefab)
        {
            _config = config;
        ...
        public async Task<ConnectResult> ConnectAsync(FusionMenuConnectArgs connectArgs)
        {
            // Safety
        ...
        public Task<List<FusionMenuOnlineRegion>> RequestAvailableOnlineRegionsAsync(FusionMenuConnectArgs connectArgs)
        {
            // Force best region
